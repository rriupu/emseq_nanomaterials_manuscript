rule fastqc_after_alignment:
    ...
    output:
        html = "results/qc_reports/after_alignment/{sample}/{sample}_aligned_reads_fastqc.html",
        zipfile = "results/qc_reports/after_alignment/{sample}/{sample}_aligned_reads_fastqc.zip"
    params:
